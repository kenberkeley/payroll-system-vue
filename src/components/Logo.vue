<template>
  <!-- Copy & paste from https://www.myob.com -->
  <svg preserveAspectRatio="xMidYMin slice" data-name="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 116.4" aria-label="MYOB Home">
    <title>MYOB</title>
    <defs>
